...
maxw2Options<-list(2, 10, 100) #.1 performs worse and 1000 doesn't make a difference
#lossOptions Options aren't well defined for what to put in r
balance_classesOptions<-list(F)#T
dataTransformationOptions<-c(modificationList, list())#list("raw", "sqrt", "log")
